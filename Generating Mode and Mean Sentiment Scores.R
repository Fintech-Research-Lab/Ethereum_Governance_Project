...
# on 5-18-2023 this code was modified to include author1 - author6 fields in the depracated code because we need this in stata to create dummies for
# ethereum foundation and Vitalik, I also added author7 which was missed in the previous code
